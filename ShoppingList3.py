...
def remove_item(idx):
    indx = idx - 1
    item = shopping_list.pop(indx)
    print("Remove {}.".format(item))
    

def show_help():
    print("\nSeparate each item with a comma.")
    print("Type DONE to quit, SHOW to see the current list, REMOVE to delete and item, and HELP to get this message.")
...
while True:
    ...
    if new_stuff == "DONE":
        ...
        show_list()
        idx = raw_input("Which item? Tell the number. ")
        remove_item(int(idx))
        continue
    else:
